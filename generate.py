...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            latex_text = render_resume_latex(tailored, source_resume=current_resume)
        ...
        self._send_json(
            200,
            {
                ...
                'latexBase64': base64.b64encode(latex_text.encode('utf-8')).decode('utf-8'),
                ...
                'latexFileName': f"{(tailored.name or 'tailored_resume').replace(' ', '_').lower()}_tailored_resume.tex",
                'reviewRequired': True,
            },
        )
